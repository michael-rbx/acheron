...
do
    ...
    WatermarkBackground.Position = UDim2.new(0.5, 0, 1, -5)
    WatermarkBackground.AnchorPoint = Vector2.new(0.5, 1)
    ...
    function Library:Toggle(Value: boolean?)
        ...
        if Library.Toggled and not Library.IsMobile then
            ...
            RunService:BindToRenderStep("ShowCursor", Enum.RenderPriority.Last.Value, function()
				...
				custom_outline.PointC = custom_cursor.PointC
				custom_outline.PointD = custom_cursor.PointD

				custom_cursor.Color = Library.Scheme.AccentColor

				custom_cursor.Visible = Library.ShowCustomCursor
				custom_outline.Visible = Library.ShowCustomCursor
